...
public class LITBonusTuttoPerTuttoWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(LITBonusTuttoPerTuttoWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/LITBonusTuttoPerTuttoWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/LITBonusTuttoPerTuttoWLAIW/InitOutcome.xml").getDocumentElement();
